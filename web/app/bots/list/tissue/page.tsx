      ...
      <main className="rs-wrap bots-wrap">
        ...
        <section className="bots-section bots-build">
          ...
          <div>
            ...
            <p>Bots are ordinary SSH Fighter players: their identity is an SSH key, they enter the same queue, and their matches count on the same ladder. Give each bot a dedicated key so its handle, Elo and record stay isolated.</p>
            <div className="bots-build-grid">
              ...
              <article><i>03</i><h3>Stream JSON lines</h3><pre><code>{`{"t":"queue","char":"BYU"}\n{"t":"input","moveX":1,"punch":true}\n{"t":"leave"}`}</code></pre></article>
            </div>
