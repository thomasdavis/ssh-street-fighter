      ...
      <main className="rs-wrap">
        ...
        <div className="rs-doc">
          <div className="rs-steps">
            ...
            <div className="rs-step"><div className="n">03</div><h4>Fight</h4><p>Choose the open, human, or bot pool; read world state each tick; send inputs.</p></div>
          </div>

          <h2>Register (over SSH)</h2>
          <p>Bots have labeled player accounts and use the same Elo calculation as humans. They appear in the Open
            League while the default Human League remains human-only. Your identity <em>is</em> your SSH key
            fingerprint, so connect once with the key you&apos;ll use and pick a handle:</p>
          ...
          <pre className="rs-pre"><span className="g">$</span> ssh <span className="k">yourbot</span>@sshfighter.com <span className="y">play</span>{'\n'}<span className="c"># then write newline-delimited JSON on stdin, read it on stdout</span>{'\n'}{'{'}<span className="k">&quot;t&quot;</span>:<span className="y">&quot;queue&quot;</span>,<span className="k">&quot;char&quot;</span>:<span className="y">&quot;BYU&quot;</span>,<span className="k">&quot;opponents&quot;</span>:<span className="y">&quot;all&quot;</span>{'}'}</pre>

          <h3>You send</h3>
          <pre className="rs-pre">{'{'}<span className="k">&quot;t&quot;</span>:<span className="y">&quot;queue&quot;</span>,<span className="k">&quot;char&quot;</span>:<span className="y">&quot;BYU&quot;</span>,<span className="k">&quot;opponents&quot;</span>:<span className="y">&quot;all&quot;</span>{'}'}  <span className="c">enter matchmaking</span>{'\n'}{'{'}<span className="k">&quot;t&quot;</span>:<span className="y">&quot;input&quot;</span>,<span className="k">&quot;moveX&quot;</span>:<span className="y">1</span>,<span className="k">&quot;punch&quot;</span>:<span className="y">true</span>,<span className="k">&quot;motion&quot;</span>:<span className="y">&quot;DR&quot;</span>{'}'}  <span className="c">act this tick</span>{'\n'}{'{'}<span className="k">&quot;t&quot;</span>:<span className="y">&quot;leave&quot;</span>{'}'}                    <span className="c">quit the current match / queue</span>{'\n'}{'{'}<span className="k">&quot;t&quot;</span>:<span className="y">&quot;help&quot;</span>{'}'}                     <span className="c">print the full protocol</span></pre>
          <p><b>opponent pools:</b> <code>all</code> (the bot default), <code>humans</code>, or <code>bots</code>. A match is created only when both players&apos; preferences accept one another, including after regional fallback.</p>
          <p><b>input fields:</b> <code>moveX</code> (-1/0/1), <code>down</code>, <code>jump</code>, <code>punch</code>, <code>kick</code>, <code>throw</code>, <code>motion</code> — all optional per tick.</p>
          <p><code>throw</code> is a close-range <b>unblockable grab</b> — it beats a blocking opponent but whiffs (and is punishable) if they&apos;re not right next to you or are airborne. It&apos;s the answer to a turtle.</p>

          <h3>You receive</h3>
          <pre className="rs-pre">{'{'}<span className="k">&quot;t&quot;</span>:<span className="y">&quot;welcome&quot;</span>,<span className="k">&quot;name&quot;</span>:...,<span className="k">&quot;playerType&quot;</span>:<span className="y">&quot;bot&quot;</span>,<span className="k">&quot;elo&quot;</span>:...,<span className="k">&quot;engine&quot;</span>:<span className="y">&quot;sf-7&quot;</span>,<span className="k">&quot;commit&quot;</span>:...,<span className="k">&quot;build&quot;</span>:...{'}'}{'\n'}{'{'}<span className="k">&quot;t&quot;</span>:<span className="y">&quot;matchStart&quot;</span>,<span className="k">&quot;role&quot;</span>:<span className="y">&quot;a&quot;</span>,<span className="k">&quot;stage&quot;</span>:...,<span className="k">&quot;oppName&quot;</span>:...,<span className="k">&quot;oppType&quot;</span>:<span className="y">&quot;human&quot;</span>,<span className="k">&quot;engine&quot;</span>:...,<span className="k">&quot;commit&quot;</span>:...{'}'}{'\n'}{'{'}<span className="k">&quot;t&quot;</span>:<span className="y">&quot;state&quot;</span>,<span className="k">&quot;frame&quot;</span>:...,<span className="k">&quot;phase&quot;</span>:...,<span className="k">&quot;you&quot;</span>:{'{'}...{'}'},<span className="k">&quot;opp&quot;</span>:{'{'}...{'}'},<span className="k">&quot;projectiles&quot;</span>:[...]{'}'}{'\n'}{'{'}<span className="k">&quot;t&quot;</span>:<span className="y">&quot;matchEnd&quot;</span>,<span className="k">&quot;result&quot;</span>:{'{'}<span className="k">&quot;youWon&quot;</span>:<span className="y">true</span>...{'}'}{'}'}</pre>
          <p>The initial <code>hi</code> and <code>welcome</code>, plus every <code>matchStart</code>, identify the exact server build. Log <code>build</code> with your results so a fight can always be tied back to its engine family and source revision.</p>
