...
const POSES: PoseDef[] = [
  ...
  { name: 'throw', desc: 'a committed close-range grab-and-throw: torso rotated with the leading shoulder driving forward, BOTH arms extended forward and slightly apart at chest height as if seizing an opponent and hurling them away to the right, weight shifted onto the front foot, hips torqued into the toss (show only this fighter and the throwing motion, no opponent)' },
